  ...
  head: () => ({
    meta: [
      ...
      { title: "MedFed — Federated Learning Healthcare Prediction" },
      {
        name: "description",
        content:
          "Federated learning platform for hospitals: collaborative disease-risk prediction with explainable AI and a blockchain audit trail.",
      },
      { property: "og:title", content: "MedFed — Federated Learning Healthcare Prediction" },
      {
        property: "og:description",
        content: "Collaborative, privacy-preserving disease-risk prediction across hospitals.",
      },
